...
const ITEM_DATA = {
	"cano": {"name": "Cano", "id": "cano", "description": "Um cano de metal. Dano baixo.", "type": "weapon", "damage": 10, "icon_path": "res://icon.svg", "combinable": false},
	"faca": {"name": "Faca", "id": "faca", "description": "Uma faca afiada. Dano moderado.", "type": "weapon", "damage": 15, "icon_path": "res://icon.svg", "combinable": false},
	"green_herb": {"name": "Erva Verde", "id": "green_herb", "description": "Uma erva medicinal comum.", "type": "consumable", "icon_path": "res://icon.svg", "quantity": 1, "heal_amount": 20, "combinable": true},
	"red_herb": {"name": "Erva Vermelha", "id": "red_herb", "description": "Uma erva rara. Potencializa outras ervas.", "type": "ingredient", "icon_path": "res://icon.svg", "quantity": 1, "combinable": true},
	"medkit": {"name": "Kit Médico", "id": "medkit", "description": "Recupera bastante vida.", "type": "consumable", "icon_path": "res://icon.svg", "quantity": 1, "heal_amount": 60, "combinable": false},
	"green_herb_plus": {"name": "Erva Verde+", "id": "green_herb_plus", "description": "Duas ervas verdes combinadas. Cura moderada.", "type": "consumable", "icon_path": "res://icon.svg", "quantity": 1, "heal_amount": 50, "combinable": true},
